...
const style = {
  ...
  navItem: `px-4 py-2 m-1 flex items-center text-lg font-semibold text-[0.9rem] cursor-pointer rounded-3xl hover:bg-[#f7ebf0]`,
...
const darkStyle = {
  ...
  navItem: `px-4 py-2 m-1 flex items-center text-lg font-semibold text-[0.9rem] cursor-pointer rounded-3xl hover:bg-[#02262d]`,
